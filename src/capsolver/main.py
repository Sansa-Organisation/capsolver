...
app = FastAPI(
    ...
    version="0.3.6",
    description=(
        "Open-source self-hosted CAPTCHA solver v0.3.6 for ALL types - 100% own solver, no external API, trusted CDP drag fix F015->F000 + robust selector polling 10x window-show re-click + StdRng Send + cdc_ stealth: "
