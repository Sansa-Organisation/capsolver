...
app = FastAPI(
    ...
    version="0.3.9",
    description=(
        "Open-source self-hosted CAPTCHA solver v0.3.9 for ALL types - 100% own solver, no external API, trusted CDP drag + T001 true securityToken proven via direct sweep slider 200->710 + broad sweep fallback [50,100,150,200,239,260] for mis-detection: "
...
async def root():
    return {
        ...
        "features": {
            "aliyun": "INPAINTING/SLIDER v0.3.9 T001 true securityToken from verify JSON, broad sweep fallback, stealth F015->T001, trusted CDP",
